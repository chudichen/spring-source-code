...
import com.chu.beans.factory.InitializingBean;
import com.chu.beans.factory.config.*;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
	...
	protected Object applyBeanPostProcessorsBeforeInstantiation(Class<?> beanClass, String className) {
		for (BeanPostProcessor beanPostProcessor : getBeanPostProcessors()) {
			if (beanPostProcessor instanceof InstantiationAwareBeanPostProcessor) {
				Object result = ((InstantiationAwareBeanPostProcessor) beanPostProcessor).postProcessBeforeInstantiation(beanClass, className);
				if (result != null) {
					return result;
				}
			}
	...
	/**
	 * 注册有销毁方法的bean，即bean集成自DisposableBean或有自定义的销毁方法
	 *
	 * @param beanName 名称
	 * @param bean bean
	 * @param beanDefinition bean定义
